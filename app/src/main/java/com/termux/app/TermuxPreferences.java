...
final class TermuxPreferences {
    ...
    static TerminalSession getCurrentSession(Termux context) {
        String sessionHandle = PreferenceManager.getDefaultSharedPreferences(context.TermuxActivity).getString(TermuxPreferences.CURRENT_SESSION_KEY, "");
