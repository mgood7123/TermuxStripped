...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_STOP_SERVICE.equals(action)) {
            ...
            if (intent.getBooleanExtra(EXTRA_EXECUTE_IN_BACKGROUND, false)) {
                ...
                startActivity(new Intent(this, Termux.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
            }
        } else if (action != null) {
    ...
    private Notification buildNotification() {
        Intent notifyIntent = new Intent(this, Termux.class);
    ...
    TerminalSession createTermSession(String executablePath, String[] arguments, String cwd, boolean failSafe) {
        ...
        TerminalSession session = new TerminalSession(executablePath, cwd, args, env);
    ...
    public int removeTermSession(TerminalSession sessionToRemove) {
        ...
        if (indexOfRemoved == -1 && mTerminalSessions.isEmpty()) return -1;
