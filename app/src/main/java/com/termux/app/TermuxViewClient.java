...
public final class TermuxViewClient implements TerminalViewClient {
    ...
    final Termux mActivity;

    /** Keeping track of the special keys acting as Ctrl and Fn for the soft keyboard and other hardware keys. */
    boolean mVirtualControlKeyDown, mVirtualFnKeyDown;

    public TermuxViewClient(Termux activity) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent e, TerminalSession currentSession) {
        ...
        if (keyCode == KeyEvent.KEYCODE_ENTER && !currentSession.isRunning()) {
            if (mActivity.removeFinishedSession(currentSession)) mActivity.restart();
            return true;
            ...
            if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN || unicodeChar == 'n'/* next */) {
                ...
                InputMethodManager imm = (InputMethodManager) mActivity.TermuxActivity.getSystemService(Context.INPUT_METHOD_SERVICE);
        ...
        if (mVirtualFnKeyDown) {
            ...
            switch (lowerCase) {
                ...
                case 'v':
                    ...
                    AudioManager audio = (AudioManager) mActivity.TermuxActivity.getSystemService(Context.AUDIO_SERVICE);
